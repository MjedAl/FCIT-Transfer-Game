# PLEASE READ FIRST
# Hi. what i made was a game where player have to move around and reach the end goal based on his grades
...
# if's open we will add his grades to the DB ( it's better to take it from ODUS to validate it but since i dont have access i'll ask the user to put it)
...
# https://www.a-fa.sa/FCIT_Transfer/
# Email: 1@mjed.xyz
# Password: 123321 (i know it's bad password, it's just for demo)
# With that being said i have also two notes.
# 1- the code might not run as a .py because i used multiple libraries and edited in their code so it's better to see the .exe
...
# Name: Abdulmajeed Fauzi alahmadi
# ID: -
# Thanks
